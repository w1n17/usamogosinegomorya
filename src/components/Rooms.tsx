  ...
  const rooms = [
    {
      ...
      description:
        "В номере создана романтическая обстановка для двоих, имеется все необхожимое для комфортного проживания, включая свой санузел.",
    ...
    },
    {
      ...
      description:
        "Уютный номер на 1 этаже с собственным входом и кухней. В номере есть все необходимое для комфортного проживания.",
    ...
    },
    {
      ...
      title: "Блаженство 2",
      description:
        "Светлый и уютный номер со всем необходимым для комфортного проживания для небольшой компании или семьи.",
      capacityLabel: "3 местный",
      tags: ["2 этаж"],
    },
    {
    ...
    },
    {
      ...
      description:
        "Большой, светлый, комфортабельный номер со всеми условиями для прекрасного отдыха для небольшой компании или семьи.",
      capacityLabel: "4 местный",
      tags: ["3 этаж"],
    },
    {
      ...
      description:
        "Просторный, светлый и  комфортабельный номер со всеми условиями для прекрасного отдыха для небольшой компании или семьи.",
